  ...
  return (
    ...
    >
      <div>
        ...
        <div>
          <h1 className="text-4xl text-orange text-right mb-4">
            {pageStrings.about.journeyHeader}
          </h1>
          <div className="flex items-center">
            ...
            <p className="text-lg leading-10 my-5">
              {pageStrings.about.journeyP1}
            </p>
          </div>
          <div className="flex items-center">
            <p className="text-lg leading-10 my-5">
              {pageStrings.about.journeyP2}
            </p>
            <div>
              <svg
                version="1.1"
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <feGaussianBlur
                          ...
                          result="shadowBlurOuter1"
                        />{" "}
                        <feFlood flood-color="#000000" flood-opacity="0.21" />{" "}
                        <feComposite in2="shadowBlurOuter1" operator="in" />{" "}
                        <feMerge>
                          {" "}
                          <feMergeNode /> <feMergeNode in="SourceGraphic" />{" "}
          ...
          <p className="text-4xl text-center my-10 leading-10 text-orange">
            {pageStrings.about.journeyP5}
          </p>
        </div>
      </div>
    </motion.div>
