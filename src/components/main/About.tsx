  ...
  return (
    <div className="bg-background my-56 mx-44 p-20 rounded-lg shadow-lg font-body text-left">
      <div>
        ...
        <div>
          <h1>{pageStrings.about.journeyHeader}</h1>
          <p>{pageStrings.about.journeyP1}</p>
          <p>{pageStrings.about.journeyP2}</p>
          <p>{pageStrings.about.journeyP3}</p>
          <p>{pageStrings.about.journeyP4}</p>
          <p>{pageStrings.about.journeyP5}</p>
        </div>
      </div>
    </div>
  );
